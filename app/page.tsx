  ...
  return (
    <div className="fixed inset-0 pointer-events-none overflow-hidden">
      {particles.map((particle) => (
        <motion.div
          key={particle}
          className="absolute w-2 h-2 bg-blue-300 rounded-full opacity-10"
          initial={{
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          >
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button
                variant="ghost"
                className="text-gray-900 bg-gray-100 hover:bg-gray-200 border border-gray-200"
              >
      ...
      <section className="relative pt-32 pb-20 px-4 min-h-screen flex items-center">
        ...
        <motion.div
          className="absolute inset-0 bg-gradient-to-br from-blue-100/40 via-purple-100/40 to-pink-100/40"
          style={{ y: y1Spring }}
        />
        ...
        <div className="container mx-auto text-center max-w-6xl relative z-10">
          ...
          >
            ...
            >
              <Badge className="mb-8 bg-gradient-to-r from-blue-100/60 to-purple-100/60 text-blue-600 border-blue-300/60 text-lg px-6 py-2">
                <motion.span
            ...
            >
              ...
              >
                <Button
                  size="lg"
                  className="text-xl px-12 py-6 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 shadow-2xl shadow-blue-500/10 text-white border-0"
                >
                  Start as Brand
                  <motion.div
                    animate={{ x: [0, 5, 0] }}
              ...
              >
                <Button
                  size="lg"
                  variant="outline"
                  className="text-xl px-12 py-6 border-2 border-gray-200 text-gray-900 hover:border-purple-400 hover:bg-purple-100/30 hover:text-purple-700 backdrop-blur-sm bg-white/50"
                >
                  Join as Influencer
                </Button>
              </motion.div>
          ...
          <motion.div
            ...
            style={{ y: y2Spring }}
          >
            <div className="relative bg-gradient-to-br from-gray-100 to-white rounded-2xl p-8 border border-gray-200 shadow-2xl shadow-purple-500/10">
              <motion.div
                className="absolute inset-0 bg-gradient-to-r from-blue-100/20 to-purple-100/20 rounded-2xl"
                animate={{ opacity: [0.5, 1, 0.5] }}
                transition={{ duration: 3, repeat: Infinity }}
              />
              ...
              <div className="grid grid-cols-3 gap-4 mb-6">
                {[1, 2, 3].map((i) => (
                  <motion.div
                    key={i}
                    className="h-24 bg-gradient-to-br from-gray-200 to-gray-100 rounded-lg"
                    animate={{ y: [0, -10, 0] }}
                    transition={{
                      duration: 2,
                      delay: i * 0.2,
              ...
              <div className="grid grid-cols-2 gap-4">
                {[1, 2, 3, 4].map((i) => (
                  <motion.div
                    key={i}
                    className="h-16 bg-gradient-to-r from-blue-100/30 to-purple-100/30 rounded-lg"
                    animate={{ opacity: [0.5, 1, 0.5] }}
                    transition={{
                      duration: 1.5,
                      delay: i * 0.1,
      ...
      {/* SECTION: Stats */}
      <motion.section
        className="py-20 px-4 bg-gradient-to-r from-gray-100 to-white"
        initial={{ opacity: 0 }}
        ...
        <div className="container mx-auto">
          <div className="grid md:grid-cols-4 gap-8 text-center">
            {[
              ...
              >
                <motion.div
                  className="text-5xl font-bold bg-gradient-to-r from-blue-500 to-purple-500 bg-clip-text text-transparent mb-2"
                  whileHover={{ scale: 1.1 }}
                >
                ...
                <motion.div
                  className="absolute inset-0 bg-gradient-to-r from-blue-100/20 to-purple-100/20 rounded-lg -z-10"
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                <Card className="bg-gradient-to-br from-white to-gray-100 border-gray-200 h-full relative overflow-hidden group">
                  <motion.div
                  ...
                  <CardHeader className="relative z-10">
                    ...
                    <CardDescription className="text-gray-500 text-lg leading-relaxed">
                      {feature.description}
                    </CardDescription>
                  </CardHeader>
      ...
      <section className="py-32 px-4 bg-gradient-to-br from-gray-100 via-white to-gray-100">
        <div className="container mx-auto">
          <motion.div
            className="text-center mb-20"
            initial={{ opacity: 0, y: 50 }}
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                <Card className="bg-gradient-to-br from-white to-gray-100 border-gray-200 h-full relative overflow-hidden">
                  <motion.div
      ...
      >
        <motion.div
          className="absolute inset-0 bg-gradient-to-r from-blue-200 via-purple-200 to-pink-200"
          animate={{
            background: [
              "linear-gradient(45deg, #DBEAFE, #DDD6FE, #FBCFE8)",
              "linear-gradient(45deg, #DDD6FE, #FBCFE8, #DBEAFE)",
              "linear-gradient(45deg, #FBCFE8, #DBEAFE, #DDD6FE)",
              "linear-gradient(45deg, #DBEAFE, #DDD6FE, #FBCFE8)",
            ],
          }}
        ...
        <div className="container mx-auto text-center relative z-10">
          ...
          <motion.p
            className="text-2xl text-gray-700 mb-12 max-w-3xl mx-auto leading-relaxed"
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, delay: 0.2 }}
            viewport={{ once: true }}
          ...
          >
            ...
            >
              <Button
                size="lg"
                className="text-xl px-12 py-6 bg-blue-600 text-white hover:bg-blue-700 shadow-2xl font-semibold"
              >
                Start Free Trial
                <motion.div
            ...
            >
              <Button
                size="lg"
                variant="outline"
                className="text-xl px-12 py-6 text-blue-700 border-2 border-blue-200 hover:border-blue-400 hover:bg-blue-100/10 backdrop-blur-sm"
              >
        ...
        <div className="container mx-auto">
          ...
          >
            ...
            {[
              ...
              <div key={i}>
                <h4 className="font-semibold mb-6 text-gray-900 text-lg">
                  {column.title}
                </h4>
                <ul className="space-y-3">

...
export default function CreateCampaignPage() {
  ...
  const aiModels = [
    {
      ...
      icon: Bot,
      features: ["Basic outreach", "Simple negotiations", "Standard follow-ups"],
    },
    {
      id: "nexus-pro",
      name: "Nexus Pro",
      ...
      icon: Zap,
      features: ["Advanced negotiations", "Personalized outreach", "Contract analysis", "Performance optimization"],
    },
    {
      id: "nexus-expert",
      name: "Nexus Expert",
      ...
      icon: Brain,
      features: ["Industry expertise", "Advanced analytics", "Predictive insights", "Custom strategies"],
    },
  ]
  ...
  const generateAiName = () => {
    const prefixes = ["Flow", "Pulse", "Nova", "Echo", "Spark", "Wave", "Orbit", "Sync", "Boost", "Prime"]
    const suffixes = ["AI", "Agent", "Mind", "Bot", "Genius", "Pro", "Flow", "Hub", "Core", "Max"]
    ...
    if (formData.campaignType) {
      ...
      if (campaignTypeWords.length > 0) {
        ...
        else name = firstWord.charAt(0).toUpperCase() + firstWord.slice(1) + "Flow AI"
      }
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600">Set up your AI-powered influencer marketing campaign</p>
            </div>
          </div>
        </div>
        ...
        <Card>
          <CardContent className="p-8">
            {currentStep === 1 && (
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-600">Enter the core details of your campaign</p>
                </div>
            ...
            {currentStep === 2 && (
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-600">Define your ideal influencer audience</p>
                </div>
                  ...
                  <div>
                    ...
                    <div className="mt-2">
                      <Slider
                        ...
                        onValueChange={(value) => updateFormData("followerRange", value)}
                        max={10000000}
                        min={1000}
                        step={1000}
                        className="w-full"
                  ...
                  <div>
                    ...
                    <div className="mt-2">
                      <Slider
                        ...
                        onValueChange={(value) => updateFormData("engagementRate", value[0])}
                        max={20}
                        min={1}
                        step={0.5}
                        className="w-full"
            ...
            {currentStep === 3 && (
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-600">Specify content requirements and brand guidelines</p>
                </div>
                      ...
                      onKeyPress={(e) => {
                        if (e.key === "Enter") {
                          ...
                          if (value) {
                            ...
                            updateFormData("hashtags", [...formData.hashtags, ...newTags])
                  ...
                  <div>
                    ...
                    <div className="mt-2">
                      <Slider
                        ...
                        onValueChange={(value) => updateFormData("budgetPerInfluencer", value)}
                        max={10000}
                        min={50}
                        step={50}
                        className="w-full"
            ...
            {currentStep === 4 && (
              <div className="space-y-6">
                <div>
                  <h2 className="text-2xl font-bold text-gray-900 mb-2">AI Negotiator Setup</h2>
                  <p className="text-gray-600">Configure your personalized AI assistant for this campaign</p>
                </div>
                  ...
                  <div className="flex items-center justify-between p-4 border rounded-lg">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Let AI handle outreach, negotiations, and follow-ups automatically
                      </p>
                    </div>
                    ...
                    <>
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                          This name will be used when the AI communicates with influencers
                        </p>
                      </div>
                      ...
                      {/* AI Specialization */}
                      <div>
                        <Label htmlFor="aiSpecialization">Industry Specialization</Label>
                        <Select value={aiSpecialization} onValueChange={setAiSpecialization}>
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                          AI will use industry-specific knowledge and terminology
                        </p>
                      </div>

                      {/* AI Aggressiveness */}
                      <div>
                        <Label>Negotiation Aggressiveness: {aiAggressiveness[0]}/10</Label>
                        <div className="mt-2">
                          <Slider
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                          Higher values mean more assertive negotiations and better deals
                        </p>
                      </div>
                      ...
                      <div className="p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg border">
                        <div className="flex items-center gap-3 mb-3">
                          ...
                          <div>
                            <h4 className="font-semibold">{aiName || "Your AI Assistant"} Preview</h4>
                            <p className="text-sm text-gray-600">
                        ...
                        <div className="bg-white p-3 rounded border">
                          <p className="text-sm">
                            "Hi! I'm {aiName || "your AI assistant"} and I'll be handling outreach and negotiations for
                            your {formData.campaignType || "campaign"}. I specialize in{" "}
                            {aiSpecialization || "general marketing"} and will work to get you the best deals while
                            maintaining{" "}
                            {aiPersonalities.find((p) => p.id === aiPersonality)?.description || "professional"}{" "}
